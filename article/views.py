...
class MustReadArticleImageViewSet(ModelViewSet):
    ...
    def get_queryset(self):
        return MustReadArticleImage.objects.filter(article_id=self.kwargs.get('mustread_article_pk'))
    
    def perform_create(self, serializer):
        serializer.save(article_id=self.kwargs.get('mustread_article_pk'))
...
class DontMissArticleImageViewSet(ModelViewSet):
    ...
    def get_queryset(self):
        return DontMissArticleImage.objects.filter(article_id=self.kwargs.get('dontmiss_article_pk'))
    
    def perform_create(self, serializer):
        serializer.save(article_id=self.kwargs.get('dontmiss_article_pk'))
...
class PopularArticleImageViewSet(ModelViewSet):
    ...
    def get_queryset(self):
        return PopularArticleImage.objects.filter(article_id=self.kwargs.get('popular_article_pk'))
    
    def perform_create(self, serializer):
        serializer.save(article_id=self.kwargs.get('popular_article_pk'))
